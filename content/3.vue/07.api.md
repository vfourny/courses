...
Dans ce chapitre, on connecte le Show Watchlist à une API REST publique : les films sont récupérés depuis [TVMaze](https://www.tvmaze.com/api) au lieu d'être déclarés en dur dans le composant.
